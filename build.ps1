...
Copy-Item (Join-Path $PSScriptRoot 'setup-publish\Setup.exe') (Join-Path $out 'WWE-2K26-MyGM-Companion-V11.2.0-Setup.exe') -Force
Copy-Item (Join-Path $PSScriptRoot 'CHANGELOG.md') (Join-Path $out 'CHANGELOG-V11.2.0.md') -Force
Get-FileHash (Join-Path $out 'WWE-2K26-MyGM-Companion-V11.2.0-Setup.exe') -Algorithm SHA256 | Format-List
