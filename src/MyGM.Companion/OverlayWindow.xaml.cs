...
public partial class OverlayWindow : Window {
 ...
 public void Shutdown(){allowClose=true;Close();}
 ...
 protected override void OnClosing(System.ComponentModel.CancelEventArgs e){if(!allowClose&&Application.Current.MainWindow?.IsVisible==true){e.Cancel=true;Hide();}base.OnClosing(e);}
}
